            ...
            <div class="py-[70px] flex flex-col gap-[50px]">
                ...
                <div class="flex gap-14 items-start">
                    ...
                    <div class="flex flex-col gap-10 w-full">
                        <!-- Thumbnail -->
                        <div class="relative overflow-hidden group h-[50rem] rounded-[30px]">
                            <img src="<?= $movie['img_movie']?>"  class="object-cover rounded-[30px] w-full" alt="">
                            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                                <img src="assets/images/ic_play.svg" class="object-cover rounded-[30px]" alt="">
                            </div>
                            <a href="watching.php?id=<?= $movie['id_movie']?>" class="inset-0 absolute z-50"></a>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <?= $movie['genre']?> - Released at <?= $movie['year']?>
                                </p>
                            </div>
