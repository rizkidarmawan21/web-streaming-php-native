            ...
            <div class="pt-[30px] relative">
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5 px-3">
                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form action="controllers/Auth.php?action=register" method="POST" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            <?php
                            Flasher::flash();
                            ?>
                            <div class="form-input flex flex-col gap-3">
                                <label for="name" class="text-base font-medium text-stream-dark">Name</label>
                                <input name="name" type="text" class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline outline-stream-gray outline-1 text-base focus:outline-indigo-600 input-stream" placeholder="Your complete name" required />
                            </div>
                            <div class="form-input flex flex-col gap-3">
                                <label for="email" class="text-base font-medium text-stream-dark">Email Address</label>
                                <input name="email" type="email" class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline outline-stream-gray outline-1 text-base focus:outline-indigo-600 input-stream" placeholder="Your email address" required />
                            </div>
                            <div class="form-input flex flex-col gap-3">
                                <label for="password" class="text-base font-medium text-stream-dark">Password</label>
                                <input name="password" type="password" class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline-stream-gray outline outline-1 text-base focus:outline-indigo-600 input-stream" placeholder="Your password" required />
                            </div>
                            ...
                            <a href="sign_in.php" class="text-sm text-sky-700 underline">
