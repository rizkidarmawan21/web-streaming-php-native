...
// JIka user belum login maka lempar ke halaman login , suruh login dlu
        ...
        <aside class="fixed z-50 w-[360px] bg-stream-dark">
            <div class="flex flex-col p-12 border-r border-softpur overflow-y-auto h-screen">
                ...
                <div class="links flex flex-col mt-16 gap-2">
                    ...
                    <a href="dashboard-subscription.php" class="side-link">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="py-[70px] flex flex-col gap-[50px]">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-5 xl:gap-12">
                        <?php foreach($movieFeature as $featureMovie) : ?>
                        <div class="col-span-1 relative overflow-hidden group h-96 rounded-[30px]">
                            <img src="<?= $featureMovie['img_movie'] ?>" class="object-cover rounded-[30px]" alt="">
                            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px] z-10 translate-y-0 group-hover:translate-y-[300px] transition ease-in-out duration-500 group-hover:bg-transparent">
                                <div class="px-7 pb-7">
                                    <div class="font-medium text-xl text-white"> <?= $featureMovie['title'] ?> </div>
                                    <p class="mb-0 text-stream-gray text-base mt-[10px]"><?= $featureMovie['year'] ?></p>
                                </div>
                            </div>
                            ...
                            <a href="dashboard-movie_details.php?id=<?= $featureMovie['id_movie'] ?>" class="inset-0 absolute z-50"></a>
                        </div>
                        <?php endforeach?>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="watched-movies hidden">
                        ...
                        <?php foreach ($movie as $dataMovie) : ?>

                            <!-- Movies -->
                            <div class="relative group overflow-hidden mr-[30px]">
                                <img src="<?= $dataMovie['img_movie'] ?>" class="object-cover rounded-[30px] w-full h-[300px] w-[240px]" alt="">
                                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px] z-10 translate-y-0 group-hover:translate-y-[300px] transition ease-in-out duration-500 group-hover:bg-transparent overflow-hidden">
                                    <div class="px-7 pb-7">
                                        <div class="font-medium text-xl text-white"><?= $dataMovie['title'] ?></div>
                                        <p class="mb-0 text-stream-gray text-base mt-[10px]"><?= $dataMovie['year'] ?></p>
                                    </div>
                                </div>
                                <div class="absolute top-1/2 left-1/2 -translate-y-[500px] group-hover:-translate-y-1/2
                                -translate-x-1/2 z-20 transition ease-in-out duration-500">
                                ...
                                <a href="watching.php?id=<?= $dataMovie['id_movie'] ?>" class="inset-0 absolute z-50"></a>
                            </div>
                        <?php endforeach ?>
                    </div>
                </div>
